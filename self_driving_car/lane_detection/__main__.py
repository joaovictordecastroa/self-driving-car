...
def apply(x):
    ...
    kernel_size = cv2.getTrackbarPos("Kernel", "EdgeDetection")

    img, lines, thetas = lane_detection.get_lanes(image, min_threshold, max_threshold, kernel_size)
...
cv2.createTrackbar("Kernel", "EdgeDetection", 50, 100, apply)
